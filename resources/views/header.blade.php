        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="index.php?page=reservasi">Rerservation</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-2 text-white rounded-4" href="index.php?page=login" style="background-color: #1475b2ff; margin-top:15px; margin-right:15px;">Login</a></li>
                    </ul>
                </div>
